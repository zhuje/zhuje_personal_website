                        ...
                        <div className="col-12 col-lg-8">
                            <div className="container-fluid jz_projects_title_container ">
                                ...
                                <a href={"https://github.com/zhuje"}
                                   className="lead jz_projects_text_color">
                                    GitHub
                                </a>
                            </div>
                            <div className="container-fluid jz_projects_container">
                                ...
                                <div className="jz_projects_project-container">
                                    ...
                                    <p> A web application and social media platform where you can
                                        save and
                                        share a list of your favorite movies. </p>
                                    <h5 className="jz_projects_heading"> Specifications </h5>
                                    <ul>
                                        <li>
                                            <b> MEAN stack (MongoDB, Express, Angular, NodeJS) Full
                                                Stack </b>
                                        </li>
                                        <li>
                                            <b> Single Page Application </b> implemented for smooth
                                            transitions
                                            when navigating between pages
                                        </li>
                                        <li>
                                            <b> RESTful APIs </b> were used to expose the
                                            server-side
                                            application.
                                        </li>
                                        <li>
                                            <b> Data Modeling </b> was applied for NodeJS and
                                            MongoDB
                                            communication
                                            via Mongoose.
                                        </li>
                                        <li>
                                            <b> Sessions </b> was used to maintain user identity
                                            throughout the
                                            application.
                                        </li>
                                        <li>
                                            <b> Conditional Rendering of components </b> on the
                                            client-side
                                            application to
                                            restrict access depending on user type (standard client
                                            or
                                            administrator
                                            user).
                                        </li>
                                        <li>
                                            <b> Reactive Component </b> respond to the size of the
                                            viewport.
                                        </li>
                                    </ul>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            ...
                                            Deployed on Heroku, MongoDB Atlas used a cloud-based
                                            database
                                        </li>
                                    </ul>
                                    <br/><br/><br/>
                                    ...
                                    {/*  Personal Website    */}
                                    <a href={"/home"}>
                                        <h1 className="jz_projects_subtitles "> Personal
                                            Website </h1>
                                    </a>
                                    <Image
                                        className="jz_about_img"
